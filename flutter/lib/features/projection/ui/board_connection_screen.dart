          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                SwitchListTile(
                  title: const Text("Ghost Analysis Mode", style: TextStyle(color: Colors.white)),
                  subtitle: const Text("Don't save games to history", style: TextStyle(color: Colors.grey, fontSize: 12)),
                  value: service.isGhostMode,
                  activeColor: Colors.cyanAccent,
                  contentPadding: EdgeInsets.zero,
                  onChanged: (val) => service.setGhostMode(val),
                ),
              ],
            ),
          ),
